...
mtc::Task MTCTaskNode::createTask()
{
  ...
  const auto& hand_frame = "xarm_gripper_base_link";
  ...
  ---- *               Generate Grasp Pose                *
    ...
    //   stage->attachObject("object1", hand_frame);
  ...
  //     stage->detachObject("object1", hand_frame);
  //     place->insert(std::move(stage));
  //   }
